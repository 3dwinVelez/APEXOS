...
const SERVICE_CORRECTION_ACTIONS = ["administrative_correction", "correct_information", "change_state", "add_observation", "manage_evidence", "force_close", "view_correction_history", "approve_correction"];
...
const PERMISSION_CATALOG = [
  ...
  { key: "servicios_correcciones", label: "Correcciones administrativas de servicios", group: "operacion", module: "services", submodule: "order-corrections", actions: SERVICE_CORRECTION_ACTIONS, grants: Object.fromEntries(SERVICE_CORRECTION_ACTIONS.map((action) => [action, [["services.orders", action]]])) },
