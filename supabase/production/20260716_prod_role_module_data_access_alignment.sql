-- Production patch for the role/module/data-access alignment incident.
-- Keep RLS as the authorization layer; this patch restores the SQL grants that RLS needs.
