-- Tighten service technician access in production: assigned orders must point to an
-- active employee in the same company, while admins keep full company visibility.
