-- Non-destructive read-path indexes for high-volume production navigation.
-- The lock timeout prevents an index build from waiting indefinitely during busy traffic.
set lock_timeout = '5s';
