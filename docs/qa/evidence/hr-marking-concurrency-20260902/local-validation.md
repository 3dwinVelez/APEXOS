...
- Precertificacion masiva final aprobada sobre el commit `94167b4`: niveles 20/50/100, 850 solicitudes, 680 marcas persistidas, 170 reenvios idempotentes, 0 errores, 0 perdidas y 0 duplicados. En 100 usuarios: p50 1.624 ms, p95 2.467 ms, p99 2.511 ms y maximo 2.522 ms. Los eventos/rutas fueron eliminados y las identidades de certificacion quedaron desactivadas.
