...
- Fecha: 2026-07-14T22:01:38.096Z
- Ambiente: production
- Empresa: NYVORA
- Company ID: 82c2da06-418d-4026-8c49-b28a2db4552d
- Tenant ID: 9a6ffc43-9aec-4b1b-8943-f098a4046b97
- Sede usada: NYVORA Centro
- Marcador tecnico: nyvora_real_transport_hr_202607141705

## Usuarios y roles utilizados

- nyvora.real.admin.202607141705@internal.apexos.local | rol: NYVORA Real Admin 202607141705 | empleado: NYV-REAL-202607141705-ADM | modulo: Transporte/Talento Humano administracion
- nyvora.real.driver.202607141705@internal.apexos.local | rol: NYVORA Real Operativo 202607141705 | empleado: NYV-REAL-202607141705-DRV | modulo: Talento Humano marcaciones, checklist, ruta; Transporte lectura
- nyvora.real.operativo.202607141705@internal.apexos.local | rol: NYVORA Real Operativo 202607141705 | empleado: NYV-REAL-202607141705-OPR | modulo: Talento Humano estado incompleto
- nyvora.real.consulta.202607141705@internal.apexos.local | rol: NYVORA Real Consulta 202607141705 | empleado: NYV-REAL-202607141705-CON | modulo: Consulta permisos negativos

## Datos creados o reutilizados

- Empleado conductor: NYV-REAL-202607141705-DRV (128)
- Empleado operativo incompleto: NYV-REAL-202607141705-OPR (129)
- Vehiculo: NY1705 (18)
- Ruta: 16 en 2026-07-14
- Checklist generado desde marcacion de entrada y aprobado para ruta 16

## Pruebas ejecutadas

| Prueba | Resultado | Evidencia tecnica |
| --- | --- | --- |
| nyvora_roles_users_employees_created_or_reused | OK | `{"roles":["NYVORA Real Admin 202607141705","NYVORA Real Operativo 202607141705","NYVORA Real Consulta 202607141705"],"credentials_file":"C:\\Users\\mq1\\Documents\\Proyectos\\APEXOS\\config\\nyvora-real-test-credentials.env","users":[{"email":"nyvora.real.admin.202607141705@internal.apexos.local","role":"NYVORA Real Admin 202607141705","employee_id":127,"code":"NYV-REAL-202607141705-ADM"},{"email":"nyvora.real.driver.202607141705@internal.apexos.local","role":"NYVORA Real Operativo 202607141705","employee_id":128,"code":"NYV-REAL-202607141705-DRV"},{"email":"nyvora.real.operativo.202607141705@internal.apexos.local","role":"NYVORA Real Operativo 202607141705","employee_id":129,"code":"NYV-REAL-202607141705-OPR"},{"email":"nyvora.real.consulta.202607141705@internal.apexos.local","role":"NYVORA Real Consulta 202607141705","employee_id":130,"code":"NYV-REAL-202607141705-CON"}]}` |
| transport_vehicle_created_or_reused_for_nyvora | OK | `{"id":18,"plate":"NY1705","site":"NYVORA Centro","driver_id":128,"master_status":"apto_documentalmente","document_status":"apto_documentalmente"}` |
| hr_schedule_created_for_nyvora_processing | OK | `{"id":6,"name":"Horario Nyvora Real 202607141705","start_time":"08:00","end_time":"17:00","lunch_start_time":"12:00","lunch_end_time":"13:00"}` |
| hr_transport_route_created_for_nyvora | OK | `{"id":16,"date":"2026-07-14","vehicle_plate":"NY1705","employees":["NYV-REAL-202607141705-DRV"],"status":"active"}` |
...
| hr_driver_entry_requires_preoperational_checklist | OK | `{"checklist_id":8,"route_authorized":false}` |
...
| transport_preoperational_checklist_approved | OK | `{"checklist_id":8,"status":"aprobado","route_authorized":true}` |
| hr_full_workday_punch_flow_completed | OK | `{"punch_ids":[76,77,78,79],"types":["entrada","inicio_almuerzo","fin_almuerzo","salida"],"route_id":16,"vehicle_plate":"NY1705"}` |
...
| hr_incomplete_state_visible_and_queryable | OK | `{"punch_id":80,"attendance_next_type":"inicio_almuerzo","session_active":true,"alerts":[{"type":"sin_actividades","severity":"warning","message":"Jornada activa sin actividades registradas."}]}` |
| hr_sequence_accepts_metadata_only_route_marks | OK | `{"route_id":17,"created_type":"inicio_almuerzo","next":"fin_almuerzo"}` |
| hr_gps_and_route_tracking_queryable | OK | `{"gps_points":4,"tracking_punches":4,"route_id":16}` |
| hr_monitor_operations_map_reflects_route_punches | OK | `{"route_id":16,"monitor_route_id":16,"monitor_employee_names":["Nyvora Conductor Real 202607141705"],"punch_points":[{"id":76,"type":"entrada","user_name":"Nyvora Conductor Real 202607141705","route_id":16},{"id":77,"type":"inicio_almuerzo","user_name":"Nyvora Conductor Real 202607141705","route_id":16},{"id":78,"type":"fin_almuerzo","user_name":"Nyvora Conductor Real 202607141705","route_id":16},{"id":79,"type":"salida","user_name":"Nyvora Conductor Real 202607141705","route_id":16}],"activity_points":0}` |
| hr_workday_processing_consults_nyvora_data | OK | `{"processed":8,"driver_processed":true}` |
| transport_query_filters_detail_and_planning_ok | OK | `{"filtered_count":13,"vehicle_id":18,"plate":"NY1705","can_start_route":true,"master_status":"apto_documentalmente"}` |
| transport_route_status_changed_after_execution | OK | `{"route_id":16,"status":"completed"}` |
...
| database_closed_work_session_for_driver | OK | `{"session_id":20,"status":"cerrada","route_id":16,"preop_checklist_id":8}` |
