...
- Actualizar PostCSS directo. Sharp permanece en la versión compatible declarada por Next.
...
No se fuerza Next 14 (downgrade funcional) ni Next 16 (migración mayor) únicamente para satisfacer la agregación de `npm audit`. Incluso Next 16.2.12 declara `sharp ^0.34.5` y PostCSS 8.4.31 a la fecha de revisión. Se descartó un override Sharp 0.35 porque dejaba el árbol npm inválido. Hasta que Next publique dependencias compatibles:
